...
import { setFormAcceptedStatus } from '../store/single-offer-data-process/single-offer-data-process.slice.ts';
...
import { RatingDescriptionsList } from '../consts/consts.ts';
