...
} from '../store/single-offer-data-process/single-offer-data-process.selectors.ts';
...
import { getAuthCheckedStatus } from '../store/user-process/user-process.selectors.ts';
import { Map } from '../components/map.tsx';
import { AppRoutes, CardType, RoomTypes } from '../consts/consts.ts';
import NotFound from './not-found.tsx';
import { redirectToRoute } from '../store/actions.ts';
import { updateSingleOfferFavoritesStatus } from '../store/single-offer-data-process/single-offer-data-process.slice.ts';
